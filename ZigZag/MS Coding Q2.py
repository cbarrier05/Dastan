...
class Dastan:
    ...
    def __CreateMoveOptionOffer(self):
        self._MoveOptionOffer.append("faris") #LINE ADDED
    ...
    def __CreateMoveOptions(self):
        ...
        self._Players[0].AddToMoveOptionQueue(self.__CreateMoveOption("faris", 1)) #LINE ADDED
        ...
        self._Players[1].AddToMoveOptionQueue(self.__CreateMoveOption("faris", -1)) #LINE ADDED
