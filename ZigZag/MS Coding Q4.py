...
class Dastan:
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            # CODE CHANGE
            Wafr = False
            if self.__AwardWafr() and not self._CurrentPlayer.GetWafrAwarded():
                print("You have been awarded a Wafr, you can select any move from your queue for free this turn.")
                self._CurrentPlayer.SetWafrAwarded()
                Wafr = True
            if Wafr:
...
class Player:
    def __init__(self, N, D):
        self.__WafrAwarded = False #LINE ADDDED
        self.__Score = 100
        self.__Name = N
        self.__Direction = D
    ...
    def SetWafrAwarded(self):
        self.__WafrAwarded = True
    #CODE ADDED
