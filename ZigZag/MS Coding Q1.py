...
class Dastan:
    ...
    def __CreateCustomPlayers(self):
        p1 = input("Enter name for Player One: ")
        self._Players.append(Player(p1, 1))
        p2 = input("Enter name for Player Two: ")
        while p1==p2:
            p2 = input("Name matches Player One, enter a different name for Player Two: ")
        self._Players.append(Player(p2, -1))
    #END ADDITION
