...
class Dastan:
    ...
    def __GetSquareReference(self, Description):
        #CODE CHANGE
        print("Enter the square " + Description + " (row number followed by column number): ",end="")
        SelectedSquare = self.__GetValidInt()
        #END CHANGE
    ...
    def __UseMoveOptionOffer(self):
        #CODE CHANGE
        ReplaceChoice = -1
        print("Choose the move option from your queue to replace (1 to 5): ",end="")
        while ReplaceChoice <1 or ReplaceChoice>5:
            ReplaceChoice=self.__GetValidInt()
            if ReplaceChoice < 1 or ReplaceChoice > 5:
                print("You must enter a number from 1-5.")
                print("Please re-enter your selection: ", end="")
        #END CHANGE
    ...
    def __GetValidInt(self):
        ...
        while not valid:
            ...
            try:
                ...
                print("Invalid input, you must enter an integer, please try again: ", end="")
        return number
    #END ADDITION
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            while Choice < 1 or Choice > 3:
                #CODE CHANGE
                print("Choose move option to use from queue (1 to 3) or 9 to take the offer: ",end="")
                Choice = self.__GetValidInt()
                #END CHANGE
                if Choice == 9:
            ...
            while not SquareIsValid:
                ...
                if not SquareIsValid:
                    print("You must enter a valid square.")
                #END ADDITION
            SquareIsValid = False
            while not SquareIsValid:
